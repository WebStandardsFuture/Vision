...
function toggleMode()
{
  ...
  if (! slidemode) {
    ...
    toggleMedia(); 					// Swap style sheets
    document.body.style.cssText = document.body.b6savedstyle;	// Restore the properties
...
/* checkURL -- if the URL includes ?full, switch to slide mode immediately */
function checkURL()
{
...
if (document.readyState !== 'loading') checkURL();
else document.addEventListener('DOMContentLoaded', checkURL);
